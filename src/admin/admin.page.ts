...
<div class="wrap">
  ...
  <div class="card">
    ...
    <div class="row"><label><b>约面欢迎语</b>好友通过后发，带时间；占位符 {name} {position} {time}</label><textarea id="WELCOME_TEMPLATE" placeholder="{name}您好~ 您应聘的【{position}】岗位，一面初步约在 {time}，方便回复「可以」确认~"></textarea></div>
